...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "GridManager")
	void SetGridDataTable(UDataTable* InTileDataTable);
	
	FGridData* GetGridDataFromTable(FName GridID) const;
	void RandomizeTileIDs(const TArray<UGrid*>& AllGrids, const TArray<FName>& TileIDs);
	// properties
